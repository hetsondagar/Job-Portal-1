...
export default function GulfCompaniesPage() {
  ...
  const loadGulfCompanies = async () => {
    try {
      setLoading(true)
      const response = await apiService.getCompaniesByRegion('gulf', {
        page: currentPage,
        limit: 20,
        search: searchTerm,
      ...
      if (response.success) {
        ...
        toast.error('Failed to load Gulf companies')
      }
    } catch (error) {
      console.error('Failed to load Gulf companies:', error)
      toast.error('Failed to load Gulf companies')
    } finally {
      setLoading(false)
    }
  ...
  const exportGulfCompanies = async () => {
    try {
      ...
      if (response.success) {
        ...
        a.href = url
        a.download = `gulf-companies-export-${new Date().toISOString().split('T')[0]}.csv`
        document.body.appendChild(a)
        a.click()
        document.body.removeChild(a)
        window.URL.revokeObjectURL(url)
        
        toast.success('Gulf companies exported successfully')
      } else {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Manage companies from Gulf region</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="md:col-span-2">
                <div className="relative">
                  ...
                  <Input
                    placeholder="Search Gulf companies..."
                    value={searchTerm}
          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              <span className="flex items-center">
                ...
                Gulf Companies ({companies.length})
              </span>
          ...
          <CardContent>
            {companies.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-400">No Gulf companies found</p>
              </div>
            ) : (
        ...
        <Dialog open={showCompanyDialog} onOpenChange={setShowCompanyDialog}>
          <DialogContent className="max-w-4xl bg-slate-800 border-white/20 text-white max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>Gulf Company Details</DialogTitle>
              <DialogDescription>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2 mt-2">
                      <Badge className="bg-cyan-600">Gulf</Badge>
                      <Badge 
