...
export default function GulfEditRequirementPage() {
  ...
  useEffect(() => {
    const fetchRequirement = async () => {
      if (!params.id || typeof params.id !== 'string') {
        ...
        router.push('/gulf-dashboard/manage-requirements')
        return
      }
      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          const normalized = {
            ...
            workExperienceMin: req.experienceMin?.toString() || req.workExperienceMin?.toString() || "",
            workExperienceMax: req.experienceMax?.toString() || req.workExperienceMax?.toString() || "",
  ...
  return (
    <EmployerAuthGuard>
      <GulfEmployerAuthGuard>
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/40 to-teal-50/40 dark:from-gray-900 dark:via-gray-800/50 dark:to-gray-900 flex items-center justify-center">
