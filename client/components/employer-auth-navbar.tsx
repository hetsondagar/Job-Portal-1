        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-slate-200 dark:border-slate-700">
            <div className="space-y-2">
              <Link href="/employer-dashboard/pricing" className="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded">
                Job Posting Plans
              </Link>
              <Link href="/employer-dashboard/database-pricing" className="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded">
                Resume Database
              </Link>
