/**
 * Production Test Script for Delete Account Functionality
 * This script tests the complete delete account flow with a newly created user
 * Tests: Backend API, Database operations, GDPR compliance, Company handling
 */
...
async function cleanup() {
  ...
  try {
    ...
    // Delete the test job
    if (testJobId) {
      await Job.destroy({ where: { id: testJobId }, force: true });
    }
...
async function runProductionTest() {
  console.log('🚀 Starting Production Test for Delete Account Functionality');
